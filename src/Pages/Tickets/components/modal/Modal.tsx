    ...
    <>
      {showModal === id ? (
        <div className={s.modal}>
          ...
          <button className={s.modalBtn} onClick={() => setIsShowModalEdit(true)}>
            edit
          </button>
        </div>
      ) : null}
      {isShowModalAgree ? (
        <div className={s.modalWrapper}>
         <div className={s.modalAgree}>
          ...
          <button
            className={s.modalBtn}
            onClick={() => setIsShowModalAgree(false)}
          >
            No
          </button>
        </div>
      ...
      {isShowModalEdit ? (
         <FormEdit data={data} setData={setData} setIsShowModalEdit={setIsShowModalEdit} id={id}/>
      ) : null}
    </>
  );
};
